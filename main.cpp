    ...
    do
    {
        ...
        switch(c)
        {
            case 1: 
                ...
                break;
            case 2: 
                cout<<"Escribe el id del usuario que desea eliminar"<<endl;
                fflush(stdin);
                getline(cin,aux);
                l_usuarios.Eliminar(aux);
                break;
            case 3: 
                cout<<"Escriba el id del usuario que desea actualizar"<<endl;
                fflush(stdin);
                getline(cin,aux);
            ...
            case 5: 
                ...
                break;
            case 6: 
                cout<<"Escribe el id de la ruta que desea eliminar"<<endl;
                fflush(stdin);
                getline(cin,aux);
                l_rutas.Eliminar(aux);
                break;
            case 7: 
                cout<<"Escriba el id de la ruta que desea actualizar"<<endl;
                fflush(stdin);
                getline(cin,aux);
            ...
            case 8:
                ...
                break;
            case 9: 
                l_usuarios.Quicky(inicio, fin);
                break;
            case 10: 
                l_rutas.rutasquick(inicior,finr);
                break;
            case 11: 
                l_usuarios.Quicky(inicio,fin);
                l_usuarios.bb();
