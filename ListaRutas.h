...
public:
    ...
    void rutasquick(pRutas pLeft, pRutas pRight);
    void bRutas();
    ...
    for(int i=0; i<tam; i++)
    {
        if(actual->id == aux)
        {
         ...
         switch(c)
         {
          ...
          break;
          case 2: cout<<"Ingrese la nueva ruta"<<endl;
          cin>>actual->ruta;
          break;
          case 3: cout<<"Ingrese el nuevo origen"<<endl;
          fflush(stdin);
          getline(cin,actual->origen);
          firstUpper(actual->origen);
          break;
          case 4: cout<<"Ingrese en nuevo destino"<<endl;
          fflush(stdin);
...
void ListaRuta::rutasquick(pRutas pLeft, pRutas pRight)
{
    pRutas pStart;
	pRutas pCurrent;
	string copyid, copyorigen, copydestino;
	int copyruta;
